...
const BussinessLoan = ({ navigation }) => {
                ...
                <View style={cstyles.box}>
                    <TouchableWithoutFeedback
                        ...
                        {form.values.adhar == null ? <View>
                            ...
                            <Text style={styles.para}>Adhaar card & Pan card</Text>
                        </View> : <Pdf
                    ...
                    <TouchableWithoutFeedback
                        ...
                        {form.values.msme == null ? <View>
                            <Image style={styles.upload} source={require('../assets/cloud.svg')} />
                            <Text style={styles.title}>MSME CERTIFICATE</Text>
                            {/* <Text style={styles.para}>Last 6 months</Text> */}
                        </View> :
                            <Pdf
                    ...
                    <TouchableWithoutFeedback
                        ...
                        {form.values.itr == null ? <View>
                            <Image style={styles.upload} source={require('../assets/cloud.svg')} />
                            <Text style={styles.title}>ITR</Text>
                            {/* <Text style={styles.para}>Last 6 months</Text> */}
                        </View> :
                            <Pdf
                    ...
                    <TouchableWithoutFeedback
                        onPress={() => pickAdhar('balance')}
                        style={styles.box}>
                        {form.values.balance == null ? <View>
                            <Image style={styles.upload} source={require('../assets/cloud.svg')} />
                            <Text style={styles.title}>BALANCE SHEET</Text>
                            {/* <Text style={styles.para}>Last 6 months</Text> */}
                        </View> :
                            <Pdf
                                source={{ uri: form.values.balance.uri }}
                                style={styles.pdf} />}
                    </TouchableWithoutFeedback>
                    {form.error.balance != null && <Text style={[cstyles.error,]}>This field is required</Text>}
                </View>
            </ScrollView>
            {loading ?
                <ActivityIndicator
